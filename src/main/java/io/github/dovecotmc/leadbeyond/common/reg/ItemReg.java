...
public class ItemReg {
	public static final RegistryEntry<CardItem> CARD = LeadBeyond.REGISTRATE.item("card", CardItem::new)
			.properties(settings -> settings.group(LBItemGroup.INSTANCE).maxCount(1))
			.register();
	public static final RegistryEntry<TicketItem> TICKET = LeadBeyond.REGISTRATE.item("ticket", TicketItem::new)
			.properties(settings -> settings.group(LBItemGroup.INSTANCE).maxCount(1))
			.register();
